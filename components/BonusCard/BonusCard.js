			...
			<div key={card.number} className="card">
				<Card>
					<CardBody>
						...
						<CardText>
							<p className="card-field">{card.phone ? "Phone: " + card.phone : ""}</p>
							<p className="card-field">{card.email ? "Email: " + card.email : ""}</p>
							<p className="card-field">{card.birthdate ? "Birthdate: " + card.birthdate : ""}</p>
							<p className="card-field">{card.status ? "Status: " + card.status : ""}</p>
							<p className="card-field">{card.sales ? "Sales: " + card.sales : ""}</p>
							<p className="card-field">{card.created_date ? "Created_date: " + card.created_date : ""}</p>
							<p className="card-field">{card.balance ? "Balance: " + card.balance : ""}</p>
						</CardText>
					</CardBody>
				</Card>
			</div>
